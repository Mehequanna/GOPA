    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-10 body text-center">
          ...
          <br>
          <img src="img/mural.jpg" alt="Finished Mural on Main Street" class="center"/>
          <p>This is the final mural that Don Gray painted on the wall of Jazzy Bagel facing Main Street. The mural is a depiction of the Original Gresham Rexall Drug Store in the 1900's.</p>
          <p>Christopher Keizur with the Gresham Outlook wrote a great article on the mural:</p>
          <p>
